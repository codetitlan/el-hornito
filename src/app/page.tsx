          ...
          <>
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Upload a photo of your fridge contents and let our AI chef create personalized recipes 
                that make the most of what you already have. No more food waste, just delicious meals!
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-12">
                ...
                <div className="flex items-center gap-2 bg-white rounded-full px-4 py-2 shadow-sm border">
                  ...
                  <span className="text-sm font-medium text-gray-700">Custom Recipes</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-20 text-center">
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                <div className="relative">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">1. Take a Photo</h3>
                ...
                <div>
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">3. Get Recipe</h3>
                  <p className="text-gray-600">
