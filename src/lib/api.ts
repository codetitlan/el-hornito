...
export const mockRecipe: Recipe = {
  ...
  description: "A fresh and healthy pasta dish with vegetables from your fridge",
...
export const analyzeFridgeMock = async (
  ...
  if (preferences?.toLowerCase().includes('vegetarian')) {
    customizedRecipe = {
      ...
      description: "A delicious vegetarian pasta made with fresh garden vegetables"
    }
  }
...
export const analyzeFridge = process.env.NODE_ENV === 'development' && !process.env.ANTHROPIC_API_KEY
  ? analyzeFridgeMock
  : analyzeImage
