/**
 * Progressive Test Suite for /lib/api.ts
 * Building comprehensive coverage through small, focused tests
 */

describe('/lib/api.ts - Progressive Coverage', () => {
  ...
  describe('Step 1: hasPersonalApiKey function', () => {
  ...
  describe('Step 2: analyzeFridge function - Basic Setup', () => {
  ...
  describe('Step 3: analyzeFridge function - Advanced Scenarios', () => {
  ...
  describe('Step 3: analyzeFridge Error Handling', () => {
